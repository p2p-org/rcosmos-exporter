...
lazy_static! {
    ...
    pub static ref TENDERMINT_CURRENT_EPOCH: IntGaugeVec = IntGaugeVec::new(
        Opts::new("tendermint_current_epoch", "Tendermint current epoch"),
        &["chain_id", "network"]
    )
    .unwrap();
    pub static ref TENDERMINT_VALIDATOR_MISSING_VOTE: CounterVec = CounterVec::new(
        Opts::new(
            "tendermint_validator_missing_vote",
            "Tendermint validators missing vote"
        ),
        &["address", "chain_id", "network", "alerts"]
    )
    .unwrap();
    pub static ref TENDERMINT_BLOCK_GAS_USED: IntGaugeVec = IntGaugeVec::new(
        Opts::new("tendermint_block_gas_used", "Tendermint block gas used"),
        &["chain_id", "network", "height"]
    )
    .unwrap();
    pub static ref TENDERMINT_BLOCK_GAS_WANTED: IntGaugeVec = IntGaugeVec::new(
        Opts::new("tendermint_block_gas_wanted", "Tendermint block gas wanted"),
        &["chain_id", "network", "height"]
    )
    .unwrap();
    pub static ref TENDERMINT_CURRENT_BLOCK_HEIGHT: IntGaugeVec = IntGaugeVec::new(
        Opts::new("tendermint_current_block_height", "Tendermint current block height"),
        &["chain_id", "network"]
    )
    .unwrap();
    pub static ref TENDERMINT_CURRENT_BLOCK_TIME: IntGaugeVec = IntGaugeVec::new(
        Opts::new(
            "tendermint_current_block_time",
            "Tendermint current block time (unix)"
        ),
        &["chain_id", "network"]
    )
    .unwrap();
    pub static ref TENDERMINT_VALIDATOR_MISSED_BLOCKS: IntGaugeVec = IntGaugeVec::new(
        Opts::new(
            ...
            "Tendermint validator missed blocks"
        ),
        &["address", "chain_id", "network"]
    )
    .unwrap();
    pub static ref TENDERMINT_VALIDATOR_UPTIME: IntGaugeVec = IntGaugeVec::new(
        Opts::new("tendermint_validator_uptime", "Tendermint validator uptime"),
        &["address", "chain_id", "network"]
    )
    .unwrap();

    // Uptime tracking metrics
    pub static ref TENDERMINT_VALIDATOR_30DAYS_UPTIME: IntGaugeVec = IntGaugeVec::new(
        Opts::new("tendermint_validator_30days_uptime", "Tendermint validator 30 days uptime"),
        &["address", "chain_id", "network"]
    )
    .unwrap();
    pub static ref TENDERMINT_VALIDATOR_30DAYS_SIGNED_BLOCKS: IntGaugeVec = IntGaugeVec::new(
        Opts::new("tendermint_validator_30days_signed_blocks", "Tendermint validator 30 days signed blocks"),
        &["address", "chain_id", "network"]
    )
    .unwrap();
    pub static ref TENDERMINT_VALIDATOR_30DAYS_MISSED_BLOCKS: IntGaugeVec = IntGaugeVec::new(
        Opts::new("tendermint_validator_30days_missed_blocks", "Tendermint validator 30 days missed blocks"),
        &["address", "chain_id", "network"]
    )
    .unwrap();
    pub static ref TENDERMINT_VALIDATOR_15DAYS_UPTIME: IntGaugeVec = IntGaugeVec::new(
        Opts::new("tendermint_validator_15days_uptime", "Tendermint validator 15 days uptime"),
        &["address", "chain_id", "network"]
    )
    .unwrap();
    pub static ref TENDERMINT_VALIDATOR_15DAYS_SIGNED_BLOCKS: IntGaugeVec = IntGaugeVec::new(
        Opts::new("tendermint_validator_15days_signed_blocks", "Tendermint validator 15 days signed blocks"),
        &["address", "chain_id", "network"]
    )
    .unwrap();
    pub static ref TENDERMINT_VALIDATOR_15DAYS_MISSED_BLOCKS: IntGaugeVec = IntGaugeVec::new(
        Opts::new("tendermint_validator_15days_missed_blocks", "Tendermint validator 15 days missed blocks"),
        &["address", "chain_id", "network"]
    )
    .unwrap();
    pub static ref TENDERMINT_VALIDATOR_7DAYS_UPTIME: IntGaugeVec = IntGaugeVec::new(
        Opts::new("tendermint_validator_7days_uptime", "Tendermint validator 7 days uptime"),
        &["address", "chain_id", "network"]
    )
    .unwrap();
    pub static ref TENDERMINT_VALIDATOR_7DAYS_SIGNED_BLOCKS: IntGaugeVec = IntGaugeVec::new(
        Opts::new("tendermint_validator_7days_signed_blocks", "Tendermint validator 7 days signed blocks"),
        &["address", "chain_id", "network"]
    )
    .unwrap();
    pub static ref TENDERMINT_VALIDATOR_7DAYS_MISSED_BLOCKS: IntGaugeVec = IntGaugeVec::new(
        Opts::new("tendermint_validator_7days_missed_blocks", "Tendermint validator 7 days missed blocks"),
        &["address", "chain_id", "network"]
    )
    .unwrap();
    pub static ref TENDERMINT_VALIDATOR_1DAY_UPTIME: IntGaugeVec = IntGaugeVec::new(
        Opts::new("tendermint_validator_1day_uptime", "Tendermint validator 1 day uptime"),
        &["address", "chain_id", "network"]
    )
    .unwrap();
    pub static ref TENDERMINT_VALIDATOR_1DAY_SIGNED_BLOCKS: IntGaugeVec = IntGaugeVec::new(
        Opts::new("tendermint_validator_1day_signed_blocks", "Tendermint validator 1 day signed blocks"),
        &["address", "chain_id", "network"]
    )
    .unwrap();
    pub static ref TENDERMINT_VALIDATOR_1DAY_MISSED_BLOCKS: IntGaugeVec = IntGaugeVec::new(
        Opts::new("tendermint_validator_1day_missed_blocks", "Tendermint validator 1 day missed blocks"),
        &["address", "chain_id", "network"]
    )
    .unwrap();
    pub static ref TENDERMINT_VALIDATOR_FIRST_TIME_SEEN: IntGaugeVec = IntGaugeVec::new(
        Opts::new("tendermint_validator_first_time_seen", "Tendermint validator first time seen"),
        &["address", "chain_id", "network"]
    )
    .unwrap();
    ...
    pub static ref TENDERMINT_VALIDATOR_DELEGATOR_SHARES: GaugeVec = GaugeVec::new(
        Opts::new("tendermint_validator_delegator_shares", "Delegator shares for validator"),
        &["name", "address", "chain_id", "network"]
    ).unwrap();
    pub static ref TENDERMINT_VALIDATOR_DELEGATIONS: GaugeVec = GaugeVec::new(
        Opts::new("tendermint_validator_delegations", "Delegations for validator"),
        &["name", "address", "chain_id", "network"]
    ).unwrap();
    pub static ref TENDERMINT_VALIDATOR_UNBONDING_DELEGATIONS: GaugeVec = GaugeVec::new(
        Opts::new("tendermint_validator_unbonding_delegations", "Unbonding delegations for validator"),
        &["name", "address", "chain_id", "network"]
    ).unwrap();
    pub static ref TENDERMINT_VALIDATOR_REWARDS: GaugeVec = GaugeVec::new(
        Opts::new("tendermint_validator_rewards", "Rewards for validator"),
    ...
    pub static ref TENDERMINT_ADDRESS_BALANCE: GaugeVec = GaugeVec::new(
        Opts::new("tendermint_address_balance", "Balance for address"),
        &["address", "token", "chain_id", "network"]
    ).unwrap();
}

pub fn register_custom_metrics() {
    REGISTRY
        .register(Box::new(TENDERMINT_CURRENT_EPOCH.clone()))
        .unwrap();
    REGISTRY
        .register(Box::new(TENDERMINT_VALIDATOR_MISSING_VOTE.clone()))
        .unwrap();
    REGISTRY
    ...
    // Register uptime tracking metrics
    REGISTRY
    ...
    REGISTRY
        ...
        .unwrap();
    REGISTRY
        .register(Box::new(TENDERMINT_UPGRADE_STATUS.clone()))
        .unwrap();
    REGISTRY
